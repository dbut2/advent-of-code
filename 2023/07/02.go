...
func score(h hand) int {
	// Replace all Jokers with the highest count non-J card, this will always result in the highest score
	h.hand = strings.ReplaceAll(h.hand, "J", string(maxNonJ(h)))
